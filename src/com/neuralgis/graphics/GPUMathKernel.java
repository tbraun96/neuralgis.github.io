...
public class GPUMathKernel {
    ...
    public float[] padd(float[] a1, float[] a2){
    ...
    cublasSetVector(length, Sizeof.FLOAT, Pointer.to(a1), 1, p1, 1);
    cublasSetVector(length, Sizeof.FLOAT, Pointer.to(a2), 1, p2, 1);

    // THE ACTUAL OPERATION: MULTIPLY AND ADD
    JCublas.cublasSaxpy(length, 1f, p1, 1, p2, 1);
    
    cublasGetVector(length, Sizeof.FLOAT, p2, 1, Pointer.to(a2), 1);
